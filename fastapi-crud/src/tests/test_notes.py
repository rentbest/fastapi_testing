...
def test_create_note(test_app, monkeypatch):
    test_request_payload = {"title": "something", "description": "somethong else"}
    test_response_payload = {"id": 1, "title": "something", "description": "somethong else"}
...
def test_read_note(test_app, monkeypatch):
    test_data = {"id": 1, "title": "something", "description": "somethong else"}
...
def test_update_note(test_app, monkeypatch):
    test_updated_data = {"title": "someone", "description": "someone else", "id": 1}
    ...
    response = test_app.put("/notes/1", content=json.dumps(test_updated_data))
    assert response.status_code == 200
